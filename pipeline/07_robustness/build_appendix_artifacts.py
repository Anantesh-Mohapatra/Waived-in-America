"""Generate the robustness-appendix artifacts (figures + tables).
...
All deliverables are written to results/appendix/:
  ...
  - Tables A7-A25: a single standalone HTML document
    ...
    styled in the thesis convention (Times New Roman, en dashes).
...
def build():
    ...
    intro = (f"<p>Robustness appendix tables A7-A{tbl_n[0]-1}. Figures A13-A14 are the two PNGs alongside "
