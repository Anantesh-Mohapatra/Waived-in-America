...
#   four groups (full DLA universe, filtered comparison subset, same-FSC
#   items, treatment panel).
...
# >= 3 treated NSNs per event year, so per-year means aren't driven by 1-2 NSNs
...
# %% [markdown]
# ## F4 — Domestic share by fiscal year: four groups (thesis figure F4)
