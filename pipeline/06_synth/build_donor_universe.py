...
Writes:
  donor_universe.csv (under data/)   surviving donor NSNs + per-outcome eligibility
  filter_log.csv                     row-count audit
  waiver_exclusion_log.csv           NSNs dropped at steps 2 and 5
  (the two logs go to results/<variant>/synth/logs/)
