...
#
# Reads synth_att.csv from the variant's synth tables dir (trial:
# data/synth_trial/<variant>) and writes synth_summary.csv next to it,
# with per-outcome aggregates:
