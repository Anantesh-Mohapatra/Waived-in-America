...
def load_control_bidlink() -> pl.DataFrame:
    ...
    # Drop exact-duplicate line items present in the raw control export, which
    # would otherwise inflate a donor's pre-waiver transaction count in synth.
    n_before = raw.height
    ...
    # --- Add role and null treatment-timing columns ---
    raw = raw.with_columns(
